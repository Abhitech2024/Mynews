...
import { ScrollView, View, Text, Image, Button , StyleSheet, SafeAreaView } from 'react-native';
...
const Newslist = () => {
  ...
  //   Alert.alert('Bookmarked', 'Article has been bookmarked!');
  // };
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        {articles.map((article, index) => (
          <View key={index} style={styles.articleContainer}>
            ...
            {/* <Button title="Bookmark" onPress={() => handleBookmark(article)} /> */}
          </View>
        ))}
      </ScrollView>
    </SafeAreaView>
